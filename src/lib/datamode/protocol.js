// Data Mode Protocol (desktop) - JS scaffolding
...
export function crc32(buf) {
  // Minimal CRC32 for scaffolding; replace with optimized version if needed
...
export function encodeFrame(hdr, payload = new Uint8Array()) {
